...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AWebcamRenderer()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(pointCloud, AWebcamRenderer);
				UProperty* NewProp_pointCloud = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("pointCloud"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(pointCloud, AWebcamRenderer), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(pointCloud, AWebcamRenderer), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(color, AWebcamRenderer);
				UProperty* NewProp_color = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("color"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(color, AWebcamRenderer), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(color, AWebcamRenderer), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(depth, AWebcamRenderer);
				UProperty* NewProp_depth = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("depth"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(depth, AWebcamRenderer), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(depth, AWebcamRenderer), sizeof(bool), true);
				UProperty* NewProp_port = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("port"), RF_Public|RF_Transient|RF_MarkAsNative) UUnsizedIntProperty(CPP_PROPERTY_BASE(port, AWebcamRenderer), 0x0010000000000005);
				UProperty* NewProp_IPAddress = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("IPAddress"), RF_Public|RF_Transient|RF_MarkAsNative) UStrProperty(CPP_PROPERTY_BASE(IPAddress, AWebcamRenderer), 0x0010000000000005);
				...
				MetaData->SetValue(NewProp_pointCloud, TEXT("Category"), TEXT("Webcam"));
				MetaData->SetValue(NewProp_pointCloud, TEXT("ModuleRelativePath"), TEXT("Public/WebcamRenderer.h"));
				MetaData->SetValue(NewProp_color, TEXT("Category"), TEXT("Webcam"));
				MetaData->SetValue(NewProp_color, TEXT("ModuleRelativePath"), TEXT("Public/WebcamRenderer.h"));
				MetaData->SetValue(NewProp_depth, TEXT("Category"), TEXT("Webcam"));
				MetaData->SetValue(NewProp_depth, TEXT("ModuleRelativePath"), TEXT("Public/WebcamRenderer.h"));
				MetaData->SetValue(NewProp_port, TEXT("Category"), TEXT("Webcam"));
				MetaData->SetValue(NewProp_port, TEXT("ModuleRelativePath"), TEXT("Public/WebcamRenderer.h"));
				MetaData->SetValue(NewProp_IPAddress, TEXT("Category"), TEXT("Webcam"));
				MetaData->SetValue(NewProp_IPAddress, TEXT("ModuleRelativePath"), TEXT("Public/WebcamRenderer.h"));
#endif
			}
		}
	...
	IMPLEMENT_CLASS(AWebcamRenderer, 1409790085);
